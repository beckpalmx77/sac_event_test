...
if (strlen($_SESSION['alogin']) == "" || strlen($_SESSION['department_id']) == "") {
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="department_id" class="control-label">รหัสแผนก</label>
    ...
    <script>
        ...
        $("#department_desc").blur(function () {
            let method = $('#action').val();
            if (method === "ADD") {
                let department_id = $('#department_id').val();
                let department_desc = $('#department_desc').val();
                let formData = {action: "SEARCH", department_id: department_id, department_desc: department_desc};
                $.ajax({
