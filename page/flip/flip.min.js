...
!function () {
    ...
    t.Tick || (t.Tick = []), t.Tick.push(["view", "flip", function () {
        ...
        return t.exports = function (t) {
            ...
            var s = t.DOM, u = (t.Animation.animate, t.Extension), l = t.Date.performance, e = t.View, r = e.rooter,
                i = e.destroyer, o = e.drawer, a = e.updater, c = e.styler,
                f = u.getExtension(u.Type.EASING_FUNCTION, "ease-out-cubic"),
                d = u.getExtension(u.Type.EASING_FUNCTION, "ease-out-sine"), h = (v(p, [{
        ...
        }, t.exports.identifier = {name: "flip", type: "view"}, t.exports
    }()])
}(window), function (t, e, cn) {
    "use strict";
        ...
        var n = function () {
            ...
            function g(r, t) {
                return t.map(function (t) {
                    var e = h[t], n = Math.max(0, Math.floor(r / e));
                    return r %= e, n
                })
            }
            ...
            function y(t, e, n) {
                ...
                var u = void 0, l = void 0, s = void 0, c = n.includes("y"), f = n.includes("M");
                ...
                var d = n.map(function (t) {
                    ...
                    var n = h[t], r = Math.max(0, Math.floor(i / n));
                    return i %= n, r
                });
            ...
            var C = {Monday: 1, Tuesday: 2, Wednesday: 3, Thursday: 4, Friday: 5, Saturday: 6, Sunday: 0},
                D = {M: 1, y: 12}, N = function (t, e) {
                    ...
                    var n = 12 * (e.getFullYear() - t.getFullYear()) + (e.getMonth() - t.getMonth()), r = S(O(t), n);
            ...
            function G(r, i) {
                ...
                if ("right" === r.align && t.reverse(), r.definitions.length > t.length) for (; r.definitions.length > t.length;) {
            ...
            function et(t) {
                var e, n, r, i, o = t.split(":").map($), a = tt(o[0]),
            ...
            var it = Object.assign || function (t) {
                ...
                }, st = {}, ct = new RegExp("^[0-9]+$"), ft = new RegExp("^(true|false)$"), dt = new RegExp("^[0-9.]+$"),
                ht = new RegExp("color"), pt = new RegExp("shadow"),
                vt = new RegExp("^(follow-gradient|horizontal-gradient|vertical-gradient)"),
                mt = new RegExp("^[.0-9]+(?:ms|s){1}$"), gt = new RegExp("^transition-?(?:in|out)?$"),
                yt = new RegExp("^url\\("), wt = function (t) {
                    var e = t.match(/([a-z]+(?:\(.*?\))?)\s?(?:origin\((.*?)\))?\s?([a-z]+(?:\(.*?\))?)?\s?(?:([.0-9ms]+)?\s?(?:(ease-[a-z-]+))?\s?([.0-9ms]+)?)?/),
                        n = se(e[1]), r = cn, i = cn, o = cn, a = cn, u = cn;
                ...
                }, bt = /\s([\d]{1,3})%?$/, _t = function (t) {
                    var e = t.match(bt);
                    return {offset: e ? parseFloat(e[1]) / 100 : null, value: Et(t.replace(bt, ""))}
                }, At = [], kt = "undefined" == typeof document ? function (t) {
                    return 0
                } : function (t) {
                    ...
                    "ease-linear": nt, "ease-in-sine": function (t) {
                        ...
                        return t * (2 - t)
                    }, "ease-in-out-quad": rt, "ease-in-quart": function (t) {
                        return t * t * t * t
                        ...
                        var n = 1 < arguments.length && e !== cn ? e : 1.70158, r = +t;
                        return r * r * ((n + 1) * r - n)
                    }, "ease-out-back": function (t, e) {
                        var n = 1 < arguments.length && e !== cn ? e : 1.70158, r = t - 1;
                        return r * r * ((n + 1) * r + n) + 1
                    }, "ease-in-out-back": function (t, e) {
                        var n = 2 * t, r = n - 2, i = 1.525 * (1 < arguments.length && e !== cn ? e : 1.70158);
                        return n < 1 ? .5 * n * n * ((1 + i) * n - i) : .5 * (r * r * ((1 + i) * r + i) + 2)
                    }, "ease-out-elastic": function (t, e) {
                        var n = 1 - (1 < arguments.length && e !== cn ? e : .7), r = 2 * t;
                        if (0 === t || 1 === t) return t;
            ...
            function Ct(t) {
                ...
                var a, u, i = (u = {velocity: 0, origin: 0, position: 0, destination: 1}, {
                    getPosition: function () {
                        return u.position
                    }, cancel: l, translate: function (r, t, e, i) {
            ...
            var Tt = function (n, t, e, r) {
                var i = 1 < arguments.length && t !== cn ? t : null, o = 2 < arguments.length && e !== cn ? e : 500,
                    a = 3 < arguments.length && r !== cn ? r : 0;
                if (!n) return null;
                var u = null, l = void 0, s = null;
                return function t(e) {
                ...
                var i = 1 < arguments.length && t !== cn ? t : 1, o = 2 < arguments.length && n !== cn ? n : .01;
                return function (t) {
                ...
                var i = 1 < arguments.length && t !== cn ? t : .5, o = 2 < arguments.length && n !== cn ? n : .75,
                ...
                var i = e ? c(s.EASING_FUNCTION, e) : e, o = c(s.TRANSITION, t);
                return function (t, e, n) {
                    o.apply(cn, [t, n, e, i].concat(j(r)))
                }
            }, zt = function (i, t, e, n) {
                var o = 1 < arguments.length && t !== cn ? t : "50% 50% 0",
                    a = 2 < arguments.length && e !== cn ? e : 500, u = n;
                return function (e) {
                    var t, n = 1 < arguments.length && arguments[1] !== cn ? arguments[1] : 1, r = arguments[2];
            ...
            var ie = function t(e) {
                    ...
                    var r = 1 < arguments.length && t !== cn ? t : [], i = n;
                    return function () {
                        var t = Array.from(r);
                    ...
                    var e = t.map(function (t) {
                        var e = t.shift(), n = c(s.TRANSFORM, e) || function (t, e, n) {
                            e(t)
                        }, r = t.map(function (t) {
                ...
                }, fe = /^([\d]{4}-[\d]{1,2}-[\d]{1,2})/, de = /^(true|false)$/, he = /^[\a-zA-Z]+$/, pe = /^0[\d]+/,
                ve = /^('|")/, me = /^-?(?:\d+)?(?:\.|0\.)?[\d]+$/, ge = /^(\[)/, ye = function (t) {
                    return de.test(t) ? "true" === t : ge.test(t) ? ce(Qt(t)) : fe.test(t) ? l(t) : ve.test(t) ? Qt(t) : !he.test(t) && !pe.test(t) && me.test(t) ? parseFloat(t) : t
                }, we = function (t, e) {
                    var n = 1 < arguments.length && e !== cn ? e : {}, r = void 0, i = {};
                    ...
                    key: "options", value: function () {
                        return {
                            constants: Ve(), presets: Be(), value: null, view: null, didInit: function () {
                            }, didUpdate: function () {
            ...
            function Ue(r, t, e) {
                ...
                var s = 1 < arguments.length && t !== cn ? t : 1e3,
                    c = we({autostart: !0}, 2 < arguments.length && e !== cn ? e : {}), f = null, d = null, h = null,
                    p = 0, v = null, m = !1, g = null, y = function () {
                        n() && i() && !o() && (m = !1, k(), b())
                    }, w = function () {
                ...
                return c.autostart && u(), {
                    start: u, stop: Re(l), reset: Re(function () {
                        l(), u()
                    }), pause: Re(function () {
                        i() && !o() && (m = !0, A(), w())
                    }), resume: y
            ...
            var Ye = [], Ve = function () {
                ...
                }, Xe = {value: ne, didInit: ee, didUpdate: ee, didDestroy: ee, willDestroy: ee}, Ze = function (t, e) {
                    var n = 0 < arguments.length && t !== cn ? t : cn, r = 1 < arguments.length && e !== cn ? e : cn;
                    if (n && !V(n) && (r = n, n = cn), !n || !Te(n)) {
                        r && r.view && (r.view = function t(e) {
                            ...
                            var r = 1 < arguments.length && e !== cn ? e : {},
                                i = 2 < arguments.length && n !== cn ? n : {}, o = t.dataset, a = {meta: {}};
                    ...
                    var r = t - n.from, i = n.interval - r % n.interval;
                ...
                Qe = function (t, e, n, r) {
                    ...
                    ascii: function () {
                        ...
                        var t = 1 < arguments.length && arguments[1] !== cn ? arguments[1] : "ease-linear",
                            o = arguments[2];
                        i = Z(i);
                        var a = c(s.EASING_FUNCTION, t), u = null, l = null;
                        return function (t, e) {
                    ...
                    }, fraction: We, percentage: function () {
                        ...
                        var i = 2 < arguments.length && arguments[2] !== cn && arguments[2],
                            o = !(3 < arguments.length && arguments[3] !== cn) || arguments[3], a = null, u = null,
                            l = null;
                        return function (t, e) {
                        ...
                        var t = 0 < arguments.length && arguments[0] !== cn ? arguments[0] : "rtl",
                            ...
                            o = 2 < arguments.length && arguments[2] !== cn ? arguments[2] : 50, a = null;
                        return function (e, n) {
                            ...
                            "random" === t && function (t) {
                                for (var e = t.length; e; e--) {
                                    var n = Math.floor(Math.random() * e), r = [t[n], t[e - 1]];
                                    t[e - 1] = r[0], t[n] = r[1]
                                }
                            }(r), "rtl" === t && r.reverse();
                            !function t() {
            ...
            var nn = {x: "translateX", y: "translateY", z: "translateZ"},
                rn = {x: "rotateX", y: "rotateY", z: "rotateZ"}, on = {both: "scale", x: "scaleX", y: "scaleY"}, an = {
                    fade: function (t, e, n, r, i, o) {
                        var a = 3 < arguments.length && r !== cn ? r : rt, u = 4 < arguments.length && i !== cn ? i : 0,
                        ...
                        var u = 3 < arguments.length && r !== cn ? r : rt, l = 4 < arguments.length && i !== cn ? i : "0",
                        ...
                        var u = 4 < arguments.length && i !== cn ? i : 0, l = 5 < arguments.length && o !== cn ? o : 1;
                        if (n < 0) {
                            var s = [l, u];
                            u = s[0], l = s[1]
                        }
                        ...
                        var t = 0 < arguments.length && arguments[0] !== cn ? arguments[0] : 1, e = arguments[2];
                        return {
                            intro: [{name: "fade", parameters: [0, 1], duration: 1e3 * t, delay: Z(arguments[1])}],
                            outro: [{name: "fade", parameters: [1, 0], duration: 1e3 * t, delay: Z(e)}]
                        }
                    }, swap: function () {
                        var t = 0 < arguments.length && arguments[0] !== cn ? arguments[0] : "y",
                            e = 1 < arguments.length && arguments[1] !== cn ? arguments[1] : 1,
                            n = 2 < arguments.length && arguments[2] !== cn ? arguments[2] : 1, r = arguments[4];
                        return {
                            intro: [{
                                name: "move",
                        ...
                        var t = 0 < arguments.length && arguments[0] !== cn ? arguments[0] : 0,
                            e = 1 < arguments.length && arguments[1] !== cn ? arguments[1] : 1, n = arguments[3];
                        return {
                            intro: [{name: "scale", parameters: [t, 1], duration: 1e3 * e, delay: Z(arguments[2])}],
                            outro: [{name: "scale", parameters: [1, t], duration: 1e3 * e, delay: Z(n)}]
                        }
                    }
                };
            e(s.TRANSITION, an);
            ...
            var ln = {
                supported: function () {
                    ...
                    var t = e.CSS && e.CSS.supports, n = !!e.MSInputMethodContext && !!document.documentMode,
                    ...
                    interval: Ue, date: function (t) {
                        return t ? l(t) : b()
                    }, duration: w
                }, data: {
                    request: Ee, poll: function (t, e, n) {
                        return Ue(function () {
                            Ee(t, e)
                        }, 2 < arguments.length && n !== cn ? n : 6e4)
                    }
                }, DOM: {
                    create: Ze, destroy: function (t) {
                        var e = function (t, e) {
                    ...
                    down: function () {
                        ...
                        if ("number" != typeof e[0] || "string" != typeof e[1]) return "string" == typeof e[0] || u(e[0]) ? function (t, e) {
                            ...
                            n = we(Ke, n);
                            var r = u(t) ? t : l(t), i = Ge({
                                due: O(r), onended: function () {
                                }
                            });
                        ...
                        var r = e[0], i = e[1].toLowerCase();
                        return e.shift(), e[0] = w(r, i), e[1] = e[1] || {}, e[1].units = i, function (e, t) {
                        ...
                        n = we(Ke, n);
                        var r = u(t) ? t : l(t), i = Ge({since: O(r)});
                        return qe(n.server, function (e) {
                            i.offset = e;
                            i.timer = Ue(function () {
                                var t = v(e);
                        ...
                        return qe(o.server, function (r) {
                            ...
                            }, o.interval, {autostart: !1}), u.complete = !0, u.onload(), u.timer.start()
                        }), u
                    }
                }, plugin: {
                    add: function (t, e, n) {
