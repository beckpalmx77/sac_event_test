...
if (strlen($_SESSION['alogin']) == "" || strlen($_SESSION['department_id']) == "") {
    ...
    <style>
        ...
        .medium-text {
            font-size: 10px; /* ปรับขนาดตัวอักษรตามที่คุณต้องการ */
        }
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="large-text font-weight-bold text-uppercase mb-1">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="large-text font-weight-bold text-uppercase mb-1">Check In
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="large-text font-weight-bold text-uppercase mb-1">Not Check In
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <section class="container-fluid">
                                        <div class="large-text font-weight-bold text-uppercase mb-1 "
                                             style="color: #8F35F6;">
                                            ลงทะเบียนเข้างาน
                                            <button type='button' name='btnChkData' id='btnChkData'
                                                    class='btn btn-primary btn-xs' onclick="CheckInData(1);">Check In
                                                Data
                                                <i class="fa fa-users"></i>
                                            </button>
                                            <button type='button' name='btnChkStat' id='btnChkStat'
                                                    class='btn btn-success btn-xs' onclick="CheckInData(2);">Check In
                                                Stat
    ...
    <script>
        function CheckInData(type) {
            // Logic สำหรับการทำงานในฟังก์ชัน CheckInData

            // เปิดแท็บใหม่
            let newTab = "";

            if (type === 1) {
                newTab = window.open('Dashboard_chkin', '_blank');
            } else {
                newTab = window.open('Dashboard_stat', '_blank');
            }

            // เช็คว่าแท็บถูกบล็อกโดย browser หรือไม่
            if (newTab) {
                newTab.focus(); // ตั้งให้เป็น focus
            } else {
                alert('โปรดอนุญาตการเปิดแท็บใหม่ในเบราว์เซอร์ของคุณ');
            }
        }
    </script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        let attendance_qty = response[i].attendance_qty === 0 ? "" : response[i].attendance_qty;
