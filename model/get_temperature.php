...
$sql = "INSERT INTO temperature_data(date_time,temperature_c,temperature_f,humidity,heat_index,ip_address,ssid,status)
            VALUES (:date_time,:temperature_c,:temperature_f,:humidity,:heat_index,:ip_address,:ssid,:status)";

/*
$sql = "INSERT INTO temperature_data(date_time,temperature_c,temperature_f,humidity,heat_index,status) 
