...
if (strlen($_SESSION['alogin']) == "" || strlen($_SESSION['sale_name_id']) == "") {
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="sale_name_id" class="control-label">รหัส Sale</label>
                                                                    <input type="sale_name_id" class="form-control"
                                                                           id="sale_name_id" name="sale_name_id"
                                                                           readonly="true"
                                                                           placeholder="">
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="sale_name_desc"
    ...
    <script>
        ...
        $("#sale_name_desc").blur(function () {
            let method = $('#action').val();
            if (method === "ADD") {
                let sale_name_id = $('#sale_name_id').val();
                let sale_name_desc = $('#sale_name_desc').val();
                let formData = {action: "SEARCH", sale_name_id: sale_name_id, sale_name_desc: sale_name_desc};
                $.ajax({
                    url: 'model/manage_sale_name_process.php',
                    method: "POST",
                    data: formData,
